            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute left-0 mt-2 w-64 bg-bg-primary border border-border rounded-2xl shadow-xl z-50 overflow-hidden"
                    >
                        ...
                        <div className="p-2 border-t border-border bg-bg-secondary/10">
                            <button
