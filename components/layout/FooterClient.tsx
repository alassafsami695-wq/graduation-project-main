...
interface FooterClientProps {
    contacts: any; // Flexible to handle API unwrap variations
}
...
const FooterClient = ({ contacts }: FooterClientProps) => {
    ...
    // handle case where contacts might be { data: { ... } }, just { ... }, or an array [{ ... }]
    const rawData = (contacts as any)?.data || contacts;
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-2 group">
                            ...
                            <span className="text-2xl font-bold text-gradient">Codesphere Academy</span>
                        </div>
                ...
                <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-foreground-muted text-sm px-4 py-2 glass rounded-full border border-border/50">
                        &copy; {currentYear} <span className="font-black text-primary">Codesphere Academy</span>. جميع الحقوق محفوظة.
                    </p>
